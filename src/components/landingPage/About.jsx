...
import profile from '../../assets/img/landingPage/profile.webp';
const About = () => {
  return (
      ...
      <div className=" bg-secoundry font-poppins over ">
        ...
        <div className="">
          <div>
            ...
            <div className=" grid  ml-20 mt-12 place-content-center">
              <div className="shadow-sm border-2 mt-6 p-4 rounded-md lg:w-96 hover:shadow-xl">
                <div className="flex justify-center">
                  <img
                    src={profile}
                    alt="admin_profile"
                ...
                <div className="p-6  ">
                  <div className="flex justify-center ">
                    ...
                    <h1 className="ml-2">Binod Budhathoki</h1>
                  </div>
                  <div className="flex justify-center mt-2">
                    <img src={email} className="h-4 w-4 mt-1" alt="email"></img>
                    <h4 className="ml-2">budhathokibinod142@gmail.com</h4>
                  </div>
